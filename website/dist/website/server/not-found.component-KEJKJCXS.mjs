...
var NotFoundPage = class _NotFoundPage {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotFoundPage, selectors: [["ng-component"]], decls: 7, vars: 4, consts: [[1, "wrap"], [1, "btn", 3, "routerLink"]], template: function NotFoundPage_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotFoundPage, { className: "NotFoundPage", filePath: "src/app/features/blog/pages/not-found.component.ts", lineNumber: 25 });
})();
export {
  NotFoundPage
};
//# sourceMappingURL=not-found.component-KEJKJCXS.mjs.map
