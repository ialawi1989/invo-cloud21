...
function TagPage_Conditional_0_Conditional_7_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.t(ctx_r0.lang(), "posts_tagged", \u0275\u0275pureFunction1(10, _c1, r_r4.tag.name)));
    \u0275\u0275advance();
...
function TagPage_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(6, _c0, ctx_r0.lang()));
    \u0275\u0275advance();
...
var TagPage = class _TagPage {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TagPage, selectors: [["ng-component"]], decls: 1, vars: 1, consts: [[3, "lang", "siteName", "languages"], [1, "container"], [1, "back", 3, "routerLink"], [3, "count"], [3, "lang", "showRetry"], [3, "retry", "lang", "showRetry"], [1, "head"], [3, "posts", "layout", "lang", "display", "mobile"], [3, "pageChange", "page", "pageCount", "lang"]], template: function TagPage_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275conditionalCreate(0, TagPage_Conditional_0_Template, 8, 8);
      }
      if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TagPage, { className: "TagPage", filePath: "src/app/features/blog/pages/tag.component.ts", lineNumber: 80 });
})();
export {
  TagPage
};
//# sourceMappingURL=tag.component-NEISAVBD.mjs.map
