...
var AuthorPage = class _AuthorPage {
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      combineLatest([this.route.paramMap, this.route.queryParamMap]).pipe(map(([p, q]) => ({ lang: p.get("lang") || q.get("lang") || "en", id: p.get("authorEmployeeId") ?? "" })), distinctUntilChanged((a, b) => a.lang === b.lang && a.id === b.id)).subscribe(({ lang, id }) => {
        this.lang.set(lang);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthorPage, { className: "AuthorPage", filePath: "src/app/features/blog/pages/author.component.ts", lineNumber: 101 });
})();
export {
  AuthorPage
};
//# sourceMappingURL=author.component-QMK7MSEC.mjs.map
