...
var _c0 = (a0) => ["/", a0, "blog"];
var _c1 = () => ({ exact: true });
var _c2 = (a0, a1) => ["/", a0, "blog", "category", a1];
...
function CategoryMenuStripComponent_For_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(2, _c2, ctx_r1.lang, c_r1.slug));
    \u0275\u0275advance();
...
var CategoryMenuStripComponent = class _CategoryMenuStripComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CategoryMenuStripComponent, selectors: [["app-category-menu-strip"]], inputs: { lang: "lang", categories: "categories" }, decls: 5, vars: 7, consts: [[1, "strip"], ["routerLinkActive", "active", 1, "pill", 3, "routerLink", "routerLinkActiveOptions"], ["routerLinkActive", "active", 1, "pill", 3, "routerLink"]], template: function CategoryMenuStripComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nav", 0)(1, "a", 1);
        \u0275\u0275text(2);
        \u0275\u0275elementEnd();
        \u0275\u0275repeaterCreate(3, CategoryMenuStripComponent_For_4_Template, 2, 5, "a", 2, _forTrack0);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275attribute("aria-label", ctx.t("category"));
        \u0275\u0275advance();
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c0, ctx.lang))("routerLinkActiveOptions", \u0275\u0275pureFunction0(6, _c1));
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CategoryMenuStripComponent, { className: "CategoryMenuStripComponent", filePath: "src/app/features/blog/components/category-menu-strip.component.ts", lineNumber: 53 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BlogIndexPage, { className: "BlogIndexPage", filePath: "src/app/features/blog/pages/blog-index.component.ts", lineNumber: 122 });
})();
export {
  BlogIndexPage
};
//# sourceMappingURL=blog-index.component-YMDDZT4T.mjs.map
