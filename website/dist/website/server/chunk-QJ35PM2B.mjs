...
var BlogSeoService = class _BlogSeoService {
  ...
  breadcrumbJsonLd(post, lang) {
    ...
    if (main)
      items.push({ name: main.name, url: this.settings.blogUrl(lang, "category", main.slug) });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LanguageSwitcherComponent, { className: "LanguageSwitcherComponent", filePath: "src/app/features/blog/components/language-switcher.component.ts", lineNumber: 79 });
})();
...
var BlogHeaderComponent = class _BlogHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BlogHeaderComponent, selectors: [["app-blog-header"]], inputs: { lang: "lang", siteName: "siteName", languages: "languages", urlFor: "urlFor" }, decls: 15, vars: 9, consts: [[1, "blog-header"], [1, "left"], [1, "brand", 3, "routerLink"], [1, "dot"], [1, "search", 3, "ngSubmit"], ["aria-hidden", "true", 1, "icon"], ["type", "search", "name", "q", 3, "ngModelChange", "ngModel", "placeholder"], [1, "right"], [3, "languages", "current", "urlFor"]], template: function BlogHeaderComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", ctx.blogLink());
        \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BlogHeaderComponent, { className: "BlogHeaderComponent", filePath: "src/app/features/blog/components/blog-header.component.ts", lineNumber: 75 });
})();
...
var EmptyStateComponent = class _EmptyStateComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmptyStateComponent, selectors: [["app-empty-state"]], inputs: { title: "title", body: "body" }, ngContentSelectors: _c0, decls: 7, vars: 2, consts: [[1, "empty"], ["aria-hidden", "true", 1, "icon"]], template: function EmptyStateComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
...
function PostCardComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", ctx_r1.blogLink(ctx_r1.post.slug));
...
function PostCardComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", ctx_r1.blogLink("category", ctx_r1.post.mainCategory.slug));
    \u0275\u0275advance();
...
function PostCardComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", ctx_r1.blogLink("tag", h_r3.slug));
    \u0275\u0275advance();
...
function PostCardComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, PostCardComponent_Conditional_8_For_2_Template, 2, 2, "a", 16, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PostCardComponent_Conditional_10_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", ctx_r1.blogLink("authors", ctx_r1.post.author.id));
    \u0275\u0275advance();
...
function PostCardComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, PostCardComponent_Conditional_10_Conditional_2_Template, 2, 2, "a", 18)(3, PostCardComponent_Conditional_10_Conditional_3_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PostCardComponent, selectors: [["app-post-card"]], inputs: { post: "post", lang: "lang", display: "display", variant: "variant", reverseSide: "reverseSide", eagerLoadCover: "eagerLoadCover" }, decls: 14, vars: 12, consts: [[1, "card"], [1, "cover", 3, "routerLink"], [1, "body"], [1, "category", 3, "routerLink"], [1, "title"], [3, "click", "routerLink"], [1, "excerpt"], [1, "hashtags"], [1, "meta"], [1, "author"], [1, "date"], [1, "reading"], ["aria-hidden", "true", 1, "comments"], [1, "cover", 3, "click", "routerLink"], ["sizes", "(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw", "decoding", "async", 3, "src", "srcset", "alt"], [1, "featured-badge"], [1, "chip", "hash", 3, "routerLink"], ["alt", "", 1, "avatar", 3, "src"], [3, "routerLink"]], template: function PostCardComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", ctx.blogLink(ctx.post.slug));
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PostCardComponent, { className: "PostCardComponent", filePath: "src/app/features/blog/components/post-card.component.ts", lineNumber: 215 });
})();
...
//# sourceMappingURL=chunk-QJ35PM2B.mjs.map
