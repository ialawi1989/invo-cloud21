...
import {
  environment
} from "./chunk-SOCGLW5L.mjs";
import {
  Meta,
  Router,
  RouterLink,
  Title
} from "./chunk-OMMLR6YX.mjs";
import {
  ApplicationRef,
...
var BlogSeoService = class _BlogSeoService {
  ...
  apply(cfg) {
    ...
    const og = {
      ...
      "twitter:image": cfg.image ?? void 0
    };
    if (cfg.type === "article") {
...
function PostCardComponent_Conditional_1_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.t("featured"));
  }
}
function PostCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "img", 13);
    \u0275\u0275conditionalCreate(2, PostCardComponent_Conditional_1_Conditional_2_Template, 2, 1, "span", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(7, _c03, ctx_r0.lang, ctx_r0.post.slug));
    \u0275\u0275attribute("aria-label", ctx_r0.post.title);
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r0.post.coverImage, \u0275\u0275sanitizeUrl)("srcset", ctx_r0.srcset(ctx_r0.post.coverImage))("alt", "Cover image for " + ctx_r0.post.title);
    \u0275\u0275attribute("loading", ctx_r0.eagerLoadCover ? "eager" : "lazy");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.post.isFeatured ? 2 : -1);
  }
}
function PostCardComponent_Conditional_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(2, _c1, ctx_r0.lang, ctx_r0.post.mainCategory.slug));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.post.mainCategory.name, " ");
  }
}
...
function PostCardComponent_Conditional_8_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(2, _c2, ctx_r0.lang, h_r2.slug));
    \u0275\u0275advance();
...
function PostCardComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, PostCardComponent_Conditional_8_For_2_Template, 2, 5, "a", 15, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.post.hashtags);
  }
}
function PostCardComponent_Conditional_10_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("src", ctx_r0.post.author.image, \u0275\u0275sanitizeUrl);
  }
}
function PostCardComponent_Conditional_10_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction2(2, _c3, ctx_r0.lang, ctx_r0.post.author.id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.post.author.name);
  }
}
...
function PostCardComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, PostCardComponent_Conditional_10_Conditional_1_Template, 1, 1, "img", 16);
    \u0275\u0275conditionalCreate(2, PostCardComponent_Conditional_10_Conditional_2_Template, 2, 5, "a", 5)(3, PostCardComponent_Conditional_10_Conditional_3_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.post.author.image ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.post.author.id ? 2 : 3);
  }
}
function PostCardComponent_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.formatDate(ctx_r0.lang, ctx_r0.post.publishDate));
  }
}
function PostCardComponent_Conditional_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", ctx_r0.post.readingTime, " ", ctx_r0.t("min_read"));
  }
}
function PostCardComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("\u{1F4AC} ", ctx_r0.formatNumber(ctx_r0.lang, ctx_r0.post.commentsCount));
  }
}
var PostCardComponent = class _PostCardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PostCardComponent, selectors: [["app-post-card"]], inputs: { post: "post", lang: "lang", display: "display", variant: "variant", reverseSide: "reverseSide", eagerLoadCover: "eagerLoadCover" }, decls: 14, vars: 15, consts: [[1, "card"], [1, "cover", 3, "routerLink"], [1, "body"], [1, "category", 3, "routerLink"], [1, "title"], [3, "routerLink"], [1, "excerpt"], [1, "hashtags"], [1, "meta"], [1, "author"], [1, "date"], [1, "reading"], ["aria-hidden", "true", 1, "comments"], ["sizes", "(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw", "decoding", "async", 3, "src", "srcset", "alt"], [1, "featured-badge"], [1, "chip", "hash", 3, "routerLink"], ["alt", "", 1, "avatar", 3, "src"]], template: function PostCardComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PostCardComponent, { className: "PostCardComponent", filePath: "src/app/features/blog/components/post-card.component.ts", lineNumber: 212 });
})();
...
//# sourceMappingURL=chunk-CLNQ76O4.mjs.map
