...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SearchPage, { className: "SearchPage", filePath: "src/app/features/blog/pages/search.component.ts", lineNumber: 92 });
})();
export {
  SearchPage
};
//# sourceMappingURL=search.component-RD6EQWQ5.mjs.map
