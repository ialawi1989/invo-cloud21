...
var BLOG_ROUTES = [
  {
    ...
    children: [
      __spreadValues({
        path: "",
        loadComponent: () => import("./blog-index.component-YMDDZT4T.mjs").then((m) => m.BlogIndexPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/blog-index.component.ts" } : {}),
      __spreadValues({
        path: "search",
        loadComponent: () => import("./search.component-DHNEAN7X.mjs").then((m) => m.SearchPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/search.component.ts" } : {}),
      __spreadValues({
        path: "category/:categorySlug",
        loadComponent: () => import("./category.component-2BIPEMGB.mjs").then((m) => m.CategoryPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/category.component.ts" } : {}),
      __spreadValues({
        path: "tag/:tagSlug",
        loadComponent: () => import("./tag.component-NEISAVBD.mjs").then((m) => m.TagPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/tag.component.ts" } : {}),
      __spreadValues({
        path: "authors/:authorEmployeeId",
        loadComponent: () => import("./author.component-2YJTP2FQ.mjs").then((m) => m.AuthorPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/author.component.ts" } : {}),
      __spreadValues({
        path: ":slug",
        loadComponent: () => import("./post.component-UW7T5NDP.mjs").then((m) => m.PostPage)
...
var APP_ROUTES = [
  ...
  __spreadValues({ path: "", loadComponent: () => import("./customizer-root.component-2VBZNY4D.mjs").then((m) => m.CustomizerRoot) }, true ? { \u0275entryName: "src/app/customizer-root.component.ts" } : {}),
  __spreadValues({ path: "**", loadComponent: () => import("./not-found.component-2CZQPXIC.mjs").then((m) => m.NotFoundPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/not-found.component.ts" } : {})
];
