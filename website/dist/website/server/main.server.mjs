...
import {
  BlogSettingsService
} from "./chunk-ZTF5UDE6.mjs";
import "./chunk-7T3LTQNF.mjs";
import {
  ActivatedRoute,
  BrowserDomAdapter,
  BrowserModule,
...
var BLOG_ROUTES = [
  {
    ...
    children: [
      __spreadValues({
        path: "",
        loadComponent: () => import("./blog-index.component-ZQKRZB74.mjs").then((m) => m.BlogIndexPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/blog-index.component.ts" } : {}),
      __spreadValues({
        path: "search",
        loadComponent: () => import("./search.component-E62S5GCU.mjs").then((m) => m.SearchPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/search.component.ts" } : {}),
      __spreadValues({
        path: "category/:categorySlug",
        loadComponent: () => import("./category.component-MB245XWT.mjs").then((m) => m.CategoryPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/category.component.ts" } : {}),
      __spreadValues({
        path: "tag/:tagSlug",
        loadComponent: () => import("./tag.component-G3XO62P7.mjs").then((m) => m.TagPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/tag.component.ts" } : {}),
      __spreadValues({
        path: "authors/:authorEmployeeId",
        loadComponent: () => import("./author.component-SZATBEUB.mjs").then((m) => m.AuthorPage)
      }, true ? { \u0275entryName: "src/app/features/blog/pages/author.component.ts" } : {}),
      __spreadValues({
        path: ":slug",
        loadComponent: () => import("./post.component-QAHKSE55.mjs").then((m) => m.PostPage)
...
var APP_ROUTES = [
  ...
  __spreadValues({ path: "", loadComponent: () => import("./customizer-root.component-CJVMQ36O.mjs").then((m) => m.CustomizerRoot) }, true ? { \u0275entryName: "src/app/customizer-root.component.ts" } : {}),
  __spreadValues({ path: "**", loadComponent: () => import("./not-found.component-NZTCG5RB.mjs").then((m) => m.NotFoundPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/not-found.component.ts" } : {})
];
