...
var BLOG_CHILDREN = [
  __spreadValues({ path: "", loadComponent: () => import("./blog-index.component-BLFSDDFS.mjs").then((m) => m.BlogIndexPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/blog-index.component.ts" } : {}),
  __spreadValues({ path: "search", loadComponent: () => import("./search.component-WQE6YDEW.mjs").then((m) => m.SearchPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/search.component.ts" } : {}),
  __spreadValues({ path: "category/:categorySlug", loadComponent: () => import("./category.component-QTAUUD5Z.mjs").then((m) => m.CategoryPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/category.component.ts" } : {}),
  __spreadValues({ path: "tag/:tagSlug", loadComponent: () => import("./tag.component-A3XUVZOP.mjs").then((m) => m.TagPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/tag.component.ts" } : {}),
  __spreadValues({ path: "authors/:authorEmployeeId", loadComponent: () => import("./author.component-WL6SQ4BD.mjs").then((m) => m.AuthorPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/author.component.ts" } : {}),
  __spreadValues({ path: ":slug", loadComponent: () => import("./post.component-33ROROGM.mjs").then((m) => m.PostPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/post.component.ts" } : {})
];
...
var APP_ROUTES = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./customizer-root.component-NVYTLYFV.mjs").then((m) => m.CustomizerRoot)
  ...
  __spreadValues({ path: "**", loadComponent: () => import("./not-found.component-KEJKJCXS.mjs").then((m) => m.NotFoundPage) }, true ? { \u0275entryName: "src/app/features/blog/pages/not-found.component.ts" } : {})
];
