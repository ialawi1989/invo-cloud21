...
@Component({
  selector: 'app-product-collection-style3',
  imports: [CarouselModule, ProductGridComponent],
  templateUrl: './product-collection-style3.component.html',
  styleUrl: './product-collection-style3.component.css',
})
export class ProductCollectionStyle3Component {
