...
@Component({
  selector: 'app-category-collection-style2',
  imports: [
  ],
  templateUrl: './category-collection-style2.component.html',
  styleUrl: './category-collection-style2.component.css'
})
export class CategoryCollectionStyle2Component {
