// src/app/components/product/product-grid/product-grid-style2/product-grid-style2.component.ts
...
@Component({
  selector: 'app-product-grid-style2',
  imports: [TranslateModule, LazyImageComponent, ProductPriceComponent],
  templateUrl: './product-grid-style2.component.html',
  styleUrl: './product-grid-style2.component.css',
})
export class ProductGridStyle2Component {
