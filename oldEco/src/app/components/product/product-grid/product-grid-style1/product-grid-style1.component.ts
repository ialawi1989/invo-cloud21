// src/app/components/product/product-grid/product-grid-style1/product-grid-style1.component.ts
...
@Component({
  selector: 'app-product-grid-style1',
  imports: [ProductPriceComponent, TranslateModule, LazyImageComponent],
  templateUrl: './product-grid-style1.component.html',
  styleUrl: './product-grid-style1.component.css',
})
export class ProductGridStyle1Component implements OnInit {
  ...
  ngOnInit(): void {
    // ProductUtilityService handles cart/currency subscriptions automatically
  }
