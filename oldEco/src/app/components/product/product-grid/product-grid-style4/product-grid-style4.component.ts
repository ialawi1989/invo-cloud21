// src/app/components/product/product-grid/product-grid-style4/product-grid-style4.component.ts
...
@Component({
  selector: 'app-product-grid-style4',
  imports: [TranslateModule, LazyImageComponent, ProductPriceComponent],
  templateUrl: './product-grid-style4.component.html',
  styleUrl: './product-grid-style4.component.css',
})
export class ProductGridStyle4Component {
