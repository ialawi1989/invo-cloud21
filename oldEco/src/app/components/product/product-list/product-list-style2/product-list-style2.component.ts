// src/app/components/product/product-list/product-list-style2/product-list-style2.component.ts
...
@Component({
  selector: 'app-product-list-style2',
  imports: [
    TranslateModule,
    LazyImageComponent,
    ProductPriceComponent,
  ],
  templateUrl: './product-list-style2.component.html',
  styleUrl: './product-list-style2.component.css',
})
export class ProductListStyle2Component {
