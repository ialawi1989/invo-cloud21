// src/app/components/product/product-list/product-list-style4/product-list-style4.component.ts
...
@Component({
  selector: 'app-product-list-style4',
  imports: [
    TranslateModule,
    LazyImageComponent,
    ProductPriceComponent,
  ],
  templateUrl: './product-list-style4.component.html',
  styleUrl: './product-list-style4.component.css',
})
export class ProductListStyle4Component {
