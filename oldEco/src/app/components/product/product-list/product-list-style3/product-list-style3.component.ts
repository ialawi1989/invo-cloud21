// src/app/components/product/product-list/product-list-style3/product-list-style3.component.ts
...
@Component({
  selector: 'app-product-list-style3',
  imports: [
    TranslateModule,
    LazyImageComponent,
    ProductPriceComponent,
  ],
  templateUrl: './product-list-style3.component.html',
  styleUrl: './product-list-style3.component.css',
})
export class ProductListStyle3Component {
