...
export class CategoryCollectionStyle1 {
  title = "";
  titleColor = "#000";
  subtitle = "";
  subtitleColor = "#000";
  categories: CollectionCategoryStyle1[] = [];
  translation:any = {};

  addCollectionCategoryStyle1() {
    this.categories.push(new CollectionCategoryStyle1());
  }

  ParseJson(json: any): void {
    let _data: CollectionCategoryStyle1;
    let temp;
    for (const key in json) {
      if (key === "categories") {
        ...
        for (let i = 0; i < limit; i++) {
          _data = new CollectionCategoryStyle1();
...
export class CollectionCategoryStyle1 {
  id = "";
  categoryId = "";
  url = "";
