        ...
        ProductSingle.prototype.init = function ($el) {
            ...
            $slider.on('initialized.owl.carousel', function (e) {
                ...
                if (!document.body.classList.contains('home')) {
                    ...
                    self.isQuickview || $slider.append('<a href="javascript:void(0);" class="product-image-full"><i class="d-icon-zoom"></i></a>');
                }

                if ($slider.parent().hasClass('product-gallery-degree')) {
                    self.isQuickView || $slider.append('<a href="javascript:void(0);" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>');
                }
                // init thumbnails
                thumbsInit(self);
                    ...
                    if (!$this.hasClass('toolbox-sort')) {
                        ...
                        if ($selectMenu.is($target.parent())) {
                            ...
                            if ($target.parent().hasClass('active')) { // add select-item, and show
                                $('.select-items').show();
                                $('<a href="javascript:void(0);" class="select-item">' + $target.text() + '<i class="d-icon-times"></i></a>')
