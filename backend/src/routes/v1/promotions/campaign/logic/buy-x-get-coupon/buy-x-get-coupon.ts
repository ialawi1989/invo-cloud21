...
import {  CouponsCampaign, PromotionsCampaign } from "../../campaign.modal";
import {
  ICampaignLogic,
  CampaignReward,
  CustomerPointReward,
...
export interface BuyXGetCouponCampaign extends CouponsCampaign {
...
export const BuyXGetCouponCampaignType = "BUY_X_GET_COUPON";

export class BuyXGetCouponCampaignLogic implements ICampaignLogic {
  private settings: BuyXGetCouponCampaign;
  private start: Date;
  private end: Date;
  constructor(settings: BuyXGetCouponCampaign) {
...
const campaignProducts = this.settings.products;
    ...
    //TODO low: consider making a function that takes the invoice and the given Coupon and reason and nots to generate Coupon reward
