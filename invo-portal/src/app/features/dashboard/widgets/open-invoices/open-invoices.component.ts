import { ChangeDetectorRef, Component, Input, OnInit, ViewChild, SimpleChanges, OnDestroy, inject } from '@angular/core';
...
@Component({
  ...
  templateUrl: './open-Invioces.component.html',
  styleUrls: ['./open-Invioces.component.scss']
})
export class OpenInvoicesComponent implements OnInit, OnDestroy {
  ...
  async loadData() {
    ...
    let response = await this.dashboardService.getOpenInvoices();
