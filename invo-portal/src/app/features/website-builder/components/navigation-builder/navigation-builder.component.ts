...
@Component({
  ...
  styles: [`
    ...
    .accordion-trigger.active { background: var(--primary-50); color: var(--primary-color); }
    ...
    .menu-item:hover { border-color: var(--primary-color); box-shadow: 0 2px 8px rgba(50, 172, 193, 0.1); }
    ...
    /* Buttons */
    .btn-primary { padding: 8px 16px; background: var(--primary-color); color: white; border: none; border-radius: 6px; font-size: 13px; font-weight: 500; cursor: pointer; }
    ...
    .btn-link { background: none; border: none; color: var(--primary-color); font-size: 12px; cursor: pointer; padding: 4px 0; }
    .btn-link:hover { text-decoration: underline; }
    
    /* Form Inputs */
    .form-input { width: 100%; padding: 8px 12px; border: 1px solid #e5e7eb; border-radius: 6px; font-size: 13px; }
    .form-input:focus { outline: none; border-color: var(--primary-color); box-shadow: 0 0 0 2px rgba(50, 172, 193, 0.1); }
    ...
    .picker-item:hover { border-color: var(--primary-color); background: var(--primary-50); }
    .item-type-badge { font-size: 10px; padding: 2px 6px; background: #f3f4f6; border-radius: 10px; margin-left: auto; }
    
    /* CDK Drag */
    .cdk-drag-preview { box-shadow: 0 4px 16px rgba(0,0,0,0.15); border-color: var(--primary-color); }
