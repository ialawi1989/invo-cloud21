...
export interface PaymentMethod {
  ...
  /** Owning company — the server validates this on save. Preserved
   *  verbatim from `getPaymentMethod`; left empty for brand-new
   *  records (the back-end fills it from the auth context). */
  companyId?:       string;
